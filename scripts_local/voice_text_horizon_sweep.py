...
ap.add_argument("--cache_dir", default="cached_datasets/Mekadrom/libriheavy_cosyvoice2_smollm2")
ap.add_argument("--codebook", default="cached_datasets/Mekadrom/libriheavy_cosyvoice2_smollm2/val/cosyvoice2_codebook.pt")
