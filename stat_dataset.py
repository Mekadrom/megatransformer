...
datasets = dataset_loading.load_dataset(args.dataset_name, args.dataset_config_name, tokenizer, 99999999)
...
for batch in tqdm(dataloader, total=63100000 if "fineweb" in args.dataset_name.lower() else None):
    n_examples += 1
