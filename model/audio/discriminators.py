...
class PeriodDiscriminator(nn.Module):
    ...
    def __init__(self, period: int, kernel_size: int = 5, stride: int = 3):
        ...
        self.convs = nn.ModuleList([
            ...
            nn.utils.spectral_norm(nn.Conv2d(128, 256, (kernel_size, 1), (stride, 1), padding=(kernel_size // 2, 0))),
            nn.utils.spectral_norm(nn.Conv2d(256, 256, (kernel_size, 1), 1, padding=(kernel_size // 2, 0))),
        ])
...
class ScaleDiscriminator(nn.Module):
    ...
    def __init__(self, use_spectral_norm: bool = False):
        ...
        self.convs = nn.ModuleList([
            ...
            norm_f(nn.Conv1d(256, 256, 41, 1, groups=16, padding=20)),
            norm_f(nn.Conv1d(256, 256, 5, 1, padding=2)),
        ])
...
class CombinedDiscriminator(nn.Module):
    ...
    def __init__(
        ...
        self.mrsd = MultiResolutionSpectrogramDiscriminator(resolutions=mrsd_resolutions)
