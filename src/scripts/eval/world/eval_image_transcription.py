...
Usage:
    python -m src.scripts.eval.world.eval_image_transcription --checkpoint_path runs/my_run/checkpoint-3000 --config small_sum_dit --cache_dir ../cached_datasets/sive --include_modes text,image --max_samples 100 --bf16
"""
