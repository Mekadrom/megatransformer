...
Usage:
    python -m src.scripts.eval.world.eval_image_synthesis --checkpoint_path runs/my_run/checkpoint-3000 --config small_sum_dit --cache_dir ../cached_datasets/sive --include_modes text,image --image_vae_decoder_config litevae --max_samples 100 --bf16
"""
...
from utils.constants import BOI_TOKEN_ID
