...
After resharding, run stat-shards to regenerate `shard_index.json`:
    python -m scripts.data.preprocess_dataset stat-shards --output_dir <new_dir>

Usage:
    python -m scripts.data.reshard --input_dir ../cached_datasets/voice_sive_train --output_dir ../cached_datasets/voice_sive_train_small --samples_per_shard 1000
"""
...
def main():
    ...
    print(f"    python -m scripts.data.preprocess_dataset stat-shards --output_dir {args.output_dir}")
