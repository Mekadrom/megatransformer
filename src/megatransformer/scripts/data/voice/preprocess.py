...
# Moved to megatransformer/utils/cosyvoice2_encoders.py so that callers needing ONLY the
# CosyVoice 2 encoders do not import this module's stack (datasets, torchcrepe, SIVE, the
# speaker-encoder zoo). Re-exported here so existing imports keep working.
from megatransformer.utils.cosyvoice2_encoders import (  # noqa: E402,F401
    _preload_venv_cuda_libs,
    whisper_log_mel,
    CosyVoice2BatchProcessor,
    CampplusBatchProcessor,
)
