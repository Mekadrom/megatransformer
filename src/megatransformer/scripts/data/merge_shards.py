...
After merging, run stat-shards to regenerate `shard_index.json`:
    python -m megatransformer.scripts.data.preprocess_dataset stat-shards --output_dir <merged_dir>

Usage:
    python -m megatransformer.scripts.data.merge_shards --input_dirs cached_datasets/voice_sive/librispeech cached_datasets/voice_sive/libritts-r cached_datasets/voice_sive/mls --output_dir cached_datasets/voice_sive_train --samples_per_shard 1000 --shuffle
"""
...
def merge(
    ...
    print(f"    python -m megatransformer.scripts.data.preprocess_dataset stat-shards --output_dir {output_dir}")
