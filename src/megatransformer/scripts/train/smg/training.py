...
from megatransformer.model.voice.criteria import MultiResolutionSTFTLoss, MultiScaleMelLoss
from megatransformer.model.smg.criteria import ArcFaceLoss, AudioPerceptualLoss, MultiScaleMelSpectrogramLoss
from megatransformer.model.smg.discriminator import (
