...
Usage:
    python -m megatransformer.scripts.eval.world.eval_voice_transcription --checkpoint_path runs/my_run/checkpoint-3000 --config small_sum_dit --cache_dir ../cached_datasets/sive --include_modes text,voice --max_samples 100 --bf16
"""
