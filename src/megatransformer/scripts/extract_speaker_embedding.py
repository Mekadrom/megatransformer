...
Usage:
    python -m megatransformer.scripts.extract_speaker_embedding --audio_path path/to/reference.wav --output_path path/to/speaker_embedding.pt
...
from megatransformer.utils.speaker_encoder import get_speaker_encoder, SPEAKER_ENCODER_INPUT_TYPES
