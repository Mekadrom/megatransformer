...
from megatransformer.config.image.vae.discriminator import MULTI_SCALE_PATCH_DISCRIMINATOR_CONFIGS, MultiScalePatchDiscriminatorConfig
from megatransformer.model.discriminator import discriminator_hinge_loss
