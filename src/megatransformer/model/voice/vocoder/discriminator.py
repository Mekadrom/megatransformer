...
from megatransformer.config.voice.vocoder.discriminator import DISCRIMINATOR_CONFIGS, WaveformDomainDiscriminatorConfig, WaveformDomainMultiPeriodDiscriminatorConfig, WaveformDomainMultiResolutionDiscriminatorConfig, WaveformDomainMultiResolutionDiscriminatorConfig, WaveformDomainMultiScaleDiscriminatorConfig
from megatransformer.model.discriminator import discriminator_loss
