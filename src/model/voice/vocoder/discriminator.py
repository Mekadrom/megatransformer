...
from config.voice.vocoder.discriminator import DISCRIMINATOR_CONFIGS, WaveformDomainDiscriminatorConfig, WaveformDomainMultiPeriodDiscriminatorConfig, WaveformDomainMultiResolutionDiscriminatorConfig, WaveformDomainMultiResolutionDiscriminatorConfig, WaveformDomainMultiScaleDiscriminatorConfig
